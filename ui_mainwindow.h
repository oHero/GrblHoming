...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelGrblVersion = new QLabel(centralWidget);
        labelGrblVersion->setObjectName(QString::fromUtf8("labelGrblVersion"));

        horizontalLayout_7->addWidget(labelGrblVersion);

        GrblVersion = new QLabel(centralWidget);
        GrblVersion->setObjectName(QString::fromUtf8("GrblVersion"));
        QFont font5;
        font5.setBold(true);
        font5.setWeight(75);
        GrblVersion->setFont(font5);
        GrblVersion->setMidLineWidth(-1);

        horizontalLayout_7->addWidget(GrblVersion);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelGrblVersion->setText(QApplication::translate("MainWindow", "Firmware :", 0, QApplication::UnicodeUTF8));
        GrblVersion->setText(QApplication::translate("MainWindow", "none", 0, QApplication::UnicodeUTF8));
